...
final class JinModelSupportTests: XCTestCase {
    ...
    func testXAIGrok41FastVariantsUseExactMatch() {
        ...
        XCTAssertTrue(JinModelSupport.isFullySupported(providerType: .xai, modelID: "grok-imagine-image-2.0"))
        ...
        XCTAssertFalse(JinModelSupport.isFullySupported(providerType: .xai, modelID: "grok-imagine-image-2.0-custom"))
    ...
    func testDeepSeekUsesExactMatchForFullySupportedTag() {
        ...
        XCTAssertTrue(JinModelSupport.isFullySupported(providerType: .deepseek, modelID: "deepseek-v4-flash-vision-exp"))
        XCTAssertFalse(JinModelSupport.isFullySupported(providerType: .deepseek, modelID: "deepseek-v4-pro-custom"))
        XCTAssertFalse(JinModelSupport.isFullySupported(providerType: .deepseek, modelID: "deepseek-v4-flash-vision-exp-custom"))
    ...
    func testNewFrontierModelsSupportAndMetadata() {
        ...
        XCTAssertTrue(JinModelSupport.isFullySupported(providerType: .fireworks, modelID: "accounts/fireworks/models/glm-5p3-flash"))
        XCTAssertTrue(JinModelSupport.isFullySupported(providerType: .fireworks, modelID: "fireworks/glm-5p3-flash"))
        XCTAssertFalse(JinModelSupport.isFullySupported(providerType: .fireworks, modelID: "accounts/fireworks/models/glm-5p3-flash-custom"))
