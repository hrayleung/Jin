...
final class GeminiAdapterTests: XCTestCase {
    ...
    func testGemini36FlashCatalogEntryAdvertisesFullCapabilities() throws {
        let entry = try XCTUnwrap(ModelCatalog.entry(for: "gemini-3.6-flash", provider: .gemini))
        ...
        XCTAssertTrue(ModelCatalog.seededModels(for: .gemini).contains { $0.id == "gemini-3.6-flash" })
        XCTAssertTrue(ModelCapabilityRegistry.supportsWebSearch(for: .gemini, modelID: "gemini-3.6-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsGoogleMaps(for: .gemini, modelID: "gemini-3.6-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsCodeExecution(for: .gemini, modelID: "gemini-3.6-flash"))

        let efforts = ModelCapabilityRegistry.supportedReasoningEfforts(for: .gemini, modelID: "gemini-3.6-flash")
        XCTAssertEqual(efforts, [.minimal, .low, .medium, .high])
    }

    func testGemini37FlashCatalogEntryAdvertisesFullCapabilities() throws {
        let entry = try XCTUnwrap(ModelCatalog.entry(for: "gemini-3.7-flash", provider: .gemini))
        ...
        XCTAssertTrue(ModelCatalog.seededModels(for: .gemini).contains { $0.id == "gemini-3.7-flash" })
        XCTAssertTrue(ModelCapabilityRegistry.supportsWebSearch(for: .gemini, modelID: "gemini-3.7-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsGoogleMaps(for: .gemini, modelID: "gemini-3.7-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsCodeExecution(for: .gemini, modelID: "gemini-3.7-flash"))

        // Docs (2026-08-13): thinking_level="MINIMAL" is an API validation error on 3.7 Flash.
        let efforts = ModelCapabilityRegistry.supportedReasoningEfforts(for: .gemini, modelID: "gemini-3.7-flash")
        XCTAssertEqual(efforts, [.low, .medium, .high])
        XCTAssertFalse(efforts.contains(.minimal))
    }

    func testGemini38FlashCatalogEntryAdvertisesFullCapabilities() throws {
        let entry = try XCTUnwrap(ModelCatalog.entry(for: "gemini-3.8-flash", provider: .gemini))
        ...
        XCTAssertTrue(ModelCatalog.seededModels(for: .gemini).contains { $0.id == "gemini-3.8-flash" })
        XCTAssertTrue(ModelCapabilityRegistry.supportsWebSearch(for: .gemini, modelID: "gemini-3.8-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsGoogleMaps(for: .gemini, modelID: "gemini-3.8-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsCodeExecution(for: .gemini, modelID: "gemini-3.8-flash"))

        let efforts = ModelCapabilityRegistry.supportedReasoningEfforts(for: .gemini, modelID: "gemini-3.8-flash")
        XCTAssertEqual(efforts, [.low, .medium, .high])
        XCTAssertFalse(efforts.contains(.minimal))
    }

    func testGemini35FlashLiteCatalogEntryAdvertisesFullCapabilities() throws {
        let entry = try XCTUnwrap(ModelCatalog.entry(for: "gemini-3.5-flash-lite", provider: .gemini))
        ...
        XCTAssertFalse(entry.capabilities.contains(.imageGeneration))
        XCTAssertEqual(entry.reasoningConfig?.type, .effort)
        XCTAssertEqual(entry.reasoningConfig?.defaultEffort, .minimal)

        XCTAssertTrue(ModelCatalog.seededModels(for: .gemini).contains { $0.id == "gemini-3.5-flash-lite" })
        XCTAssertTrue(ModelCapabilityRegistry.supportsWebSearch(for: .gemini, modelID: "gemini-3.5-flash-lite"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsGoogleMaps(for: .gemini, modelID: "gemini-3.5-flash-lite"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsCodeExecution(for: .gemini, modelID: "gemini-3.5-flash-lite"))

        let efforts = ModelCapabilityRegistry.supportedReasoningEfforts(for: .gemini, modelID: "gemini-3.5-flash-lite")
        XCTAssertEqual(efforts, [.minimal, .low, .medium, .high])
    }

    func testGemini36FlashVertexCatalogEntryAdvertisesFullCapabilities() throws {
        let entry = try XCTUnwrap(ModelCatalog.entry(for: "gemini-3.6-flash", provider: .vertexai))
        ...
        XCTAssertTrue(ModelCatalog.seededModels(for: .vertexai).contains { $0.id == "gemini-3.6-flash" })
        XCTAssertTrue(ModelCapabilityRegistry.supportsWebSearch(for: .vertexai, modelID: "gemini-3.6-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsGoogleMaps(for: .vertexai, modelID: "gemini-3.6-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsCodeExecution(for: .vertexai, modelID: "gemini-3.6-flash"))
    }

    func testGemini37FlashVertexCatalogEntryAdvertisesFullCapabilities() throws {
        let entry = try XCTUnwrap(ModelCatalog.entry(for: "gemini-3.7-flash", provider: .vertexai))
        ...
        XCTAssertTrue(ModelCatalog.seededModels(for: .vertexai).contains { $0.id == "gemini-3.7-flash" })
        XCTAssertTrue(ModelCapabilityRegistry.supportsWebSearch(for: .vertexai, modelID: "gemini-3.7-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsGoogleMaps(for: .vertexai, modelID: "gemini-3.7-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsCodeExecution(for: .vertexai, modelID: "gemini-3.7-flash"))

        let efforts = ModelCapabilityRegistry.supportedReasoningEfforts(for: .vertexai, modelID: "gemini-3.7-flash")
        XCTAssertEqual(efforts, [.low, .medium, .high])
    }

    func testGemini38FlashVertexCatalogEntryAdvertisesFullCapabilities() throws {
        let entry = try XCTUnwrap(ModelCatalog.entry(for: "gemini-3.8-flash", provider: .vertexai))
        ...
        XCTAssertTrue(ModelCatalog.seededModels(for: .vertexai).contains { $0.id == "gemini-3.8-flash" })
        XCTAssertTrue(ModelCapabilityRegistry.supportsWebSearch(for: .vertexai, modelID: "gemini-3.8-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsGoogleMaps(for: .vertexai, modelID: "gemini-3.8-flash"))
        XCTAssertTrue(ModelCapabilityRegistry.supportsCodeExecution(for: .vertexai, modelID: "gemini-3.8-flash"))

        let efforts = ModelCapabilityRegistry.supportedReasoningEfforts(for: .vertexai, modelID: "gemini-3.8-flash")
        XCTAssertEqual(efforts, [.low, .medium, .high])
    }

    func testGemini35FlashLiteVertexCatalogEntryAdvertisesFullCapabilities() throws {
        let entry = try XCTUnwrap(ModelCatalog.entry(for: "gemini-3.5-flash-lite", provider: .vertexai))
        ...
        XCTAssertTrue(ModelCatalog.seededModels(for: .vertexai).contains { $0.id == "gemini-3.5-flash-lite" })
        XCTAssertTrue(ModelCapabilityRegistry.supportsWebSearch(for: .vertexai, modelID: "gemini-3.5-flash-lite"))
