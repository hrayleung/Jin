...
struct SettingsView: View {
    ...
    static let availablePlugins: [PluginDescriptor] = [
        PluginDescriptor(id: "web_search_builtin", name: "Web Search", systemImage: "globe", summary: "Use Parallel, Exa, Brave, Jina, Firecrawl, Tavily, Perplexity, or TinyFish as Jin Search engines."),
