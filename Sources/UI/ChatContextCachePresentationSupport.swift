...
extension ChatAuxiliaryControlSupport {
    static func contextCacheSummaryText(providerType: ProviderType?) -> String {
        ...
        case .githubCopilot, .openaiCompatible, .cloudflareAIGateway, .vercelAIGateway, .openrouter, .perplexity,
             ...
             .mimoTokenPlanAnthropic, .mimoTokenPlanOpenAI, .fireworks, .cerebras, .sambanova, .databricks, .modal, .morphllm, .opencodeGo, .router, .runinfra, .zyphra, .makora, .kimiForCoding, .none:
