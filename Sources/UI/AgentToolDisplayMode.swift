enum AgentToolDisplayMode: String, CaseIterable, Identifiable {
    case expanded
    ...
    var description: String {
        switch self {
        case .expanded:
            return "Agent tool activities stay expanded at all times. You can still collapse them manually."
        case .collapseOnComplete:
