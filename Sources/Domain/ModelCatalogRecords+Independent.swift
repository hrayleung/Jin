...
extension ModelCatalog {
    ...
    static let xAIRecords: [Record] = [
        ...
        Record(id: "grok-imagine-video", displayName: "Grok Imagine Video",
               ...
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: true),
        Record(id: "grok-imagine-video-1.5-preview", displayName: "Grok Imagine Video 1.5",
               capabilities: [.videoGeneration],
               contextWindow: 32_768,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: true),
        ...
        Record(id: "grok-4.20-0309-reasoning", displayName: "Grok 4.20 0309 (Reasoning)",
               ...
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "grok-4.20-0309-non-reasoning", displayName: "Grok 4.20 0309 (Non-Reasoning)",
