...
extension ModelCatalog {
    ...
    static let togetherRecords: [Record] = [
        ...
        Record(id: "meta/muse-spark-1.2", displayName: "Muse Spark 1.2",
               ...
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .medium),
               isFullySupported: true, isSeeded: true),
        Record(id: "Qwen/Qwen3.8-Flash", displayName: "Qwen3.8 Flash",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 1_000_000,
               maxOutputTokens: 131_072,
               reasoningConfig: ModelReasoningConfig(type: .toggle),
    ...
    static let opencodeGoRecords: [Record] = [
        ...
        Record(id: "muse-spark-1.3", displayName: "Muse Spark 1.3",
               capabilities: [.streaming, .toolCalling, .vision, .nativePDF, .reasoning, .promptCaching],
               contextWindow: 1_048_576,
               maxOutputTokens: 131_072,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .medium),
               isFullySupported: true, isSeeded: true),
        Record(id: "muse-spark-1.3-contributor", displayName: "Muse Spark 1.3 Contributor",
               capabilities: [.streaming, .toolCalling, .vision, .nativePDF, .reasoning, .promptCaching],
               contextWindow: 1_048_576,
               maxOutputTokens: 131_072,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .medium),
    ...
    static let morphLLMRecords: [Record] = [
        // Seeded — appear in the model picker on first launch
        Record(id: "morph-kimik3", displayName: "Kimi K3 (Fast)",
               capabilities: [.streaming],
               contextWindow: 1_048_576,
               maxOutputTokens: 131_072,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: true),
        Record(id: "morph-glm53-744b", displayName: "GLM-5.3 744B (Fast)",
               capabilities: [.streaming],
               contextWindow: 1_048_576,
               maxOutputTokens: 262_144,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: true),
        Record(id: "morph-glm53flash", displayName: "GLM-5.3-Flash (Fast)",
               capabilities: [.streaming],
               contextWindow: 1_048_576,
               maxOutputTokens: 131_072,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: true),
        Record(id: "morph-dsv4flash", displayName: "DeepSeek V4 Flash (Fast)",
               capabilities: [.streaming],
               contextWindow: 1_048_576,
               maxOutputTokens: 131_072,
               reasoningConfig: nil,
    ...
    static let basetenRecords: [Record] = [
        ...
        Record(id: "zai-org/GLM-5.3", displayName: "GLM 5.3",
               ...
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .max),
               isFullySupported: true, isSeeded: true),
        Record(id: "zai-org/GLM-5.3-Fast", displayName: "GLM 5.3 Fast",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 1_048_576,
               maxOutputTokens: 262_144,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .max),
