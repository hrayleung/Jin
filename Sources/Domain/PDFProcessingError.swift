...
enum PDFProcessingError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .mineruAPITokenMissing:
            return "MinerU OCR API token is not configured. Set it in Settings → Plugins → MinerU OCR."
        case .deepInfraAPIKeyMissing:
        ...
        case .nativePDFNotSupported(let modelName):
            return "“\(modelName)” does not support native PDF reading. Choose Mistral OCR, MinerU OCR, DeepSeek OCR (DeepInfra), Firecrawl OCR, or macOS Extract in the PDF menu."
