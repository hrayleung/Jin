...
extension ModelCatalog {
    ...
    static let openAIRecords: [Record] = [
        ...
        Record(id: "gpt-image-2.5-flare", displayName: "GPT Image 2.5 Flare",
               capabilities: [.imageGeneration],
               contextWindow: 32_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: true),
        Record(id: "gpt-image-2.5-flare-2026-09-08", displayName: "GPT Image 2.5 Flare (2026-09-08)",
               capabilities: [.imageGeneration],
               contextWindow: 32_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "gpt-image-2.5-sunburst", displayName: "GPT Image 2.5 Sunburst",
               capabilities: [.imageGeneration],
               contextWindow: 32_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: true),
        Record(id: "gpt-image-2.5-sunburst-2026-09-08", displayName: "GPT Image 2.5 Sunburst (2026-09-08)",
               capabilities: [.imageGeneration],
               contextWindow: 32_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
    ...
    static let cloudflareAIGatewayRecords: [Record] = [
        ...
        Record(id: "google-ai-studio/gemini-3.1-flash-lite", displayName: "Gemini 3.1 Flash-Lite",
               ...
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .minimal),
               isFullySupported: true, isSeeded: false),
        // Stealth Union Alpha + Unbiased Pareto (Cloudflare third-party catalog,
        // developers.cloudflare.com/ai-gateway/models, surfaced 2026-09-16/17).
        // Metadata mirrors the OpenRouter copies (live /models, 2026-09-20).
        ...
        Record(id: "unbiased/pareto", displayName: "Unbiased: Pareto",
               ...
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        // Additional xAI third-party rows on the Cloudflare catalog.
        Record(id: "xai/grok-4.3", displayName: "Grok 4.3",
               ...
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: ReasoningEffort.none),
               isFullySupported: true, isSeeded: false),
        Record(id: "xai/grok-4.20-0309-reasoning", displayName: "Grok 4.20",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning],
               contextWindow: 1_000_000,
               maxOutputTokens: 1_000_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "xai/grok-4.20-0309-non-reasoning", displayName: "Grok 4.20 (Non-Reasoning)",
               capabilities: [.streaming, .toolCalling, .vision],
               contextWindow: 1_000_000,
               maxOutputTokens: 1_000_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "xai/grok-4.20-multi-agent-0309", displayName: "Grok 4.20 Multi-Agent",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning],
               contextWindow: 1_000_000,
               maxOutputTokens: 1_000_000,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: ReasoningEffort.none),
               isFullySupported: true, isSeeded: false),
        // Alibaba + Thinking Machines third-party rows missing from the table.
        Record(id: "alibaba/qwen3-max", displayName: "Qwen3 Max",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 262_144,
               maxOutputTokens: 65_536,
               reasoningConfig: ModelReasoningConfig(type: .toggle),
               isFullySupported: true, isSeeded: false),
        Record(id: "alibaba/qwen3.5-397b-a17b", displayName: "Qwen3.5 397B A17B",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning],
               contextWindow: 262_144,
               reasoningConfig: ModelReasoningConfig(type: .toggle),
               isFullySupported: true, isSeeded: false),
        Record(id: "alibaba/qwen3.7-max", displayName: "Qwen3.7 Max",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning],
               contextWindow: 1_000_000,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: ReasoningEffort.none),
               isFullySupported: true, isSeeded: false),
        Record(id: "alibaba/qwen3.7-plus", displayName: "Qwen3.7 Plus",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning],
               contextWindow: 262_144,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: ReasoningEffort.none),
               isFullySupported: true, isSeeded: false),
        Record(id: "alibaba/qwen3.8-max", displayName: "Qwen3.8 Max",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning],
               contextWindow: 1_000_000,
               maxOutputTokens: 131_072,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: ReasoningEffort.none),
               isFullySupported: true, isSeeded: false),
        Record(id: "thinkingmachines/inkling-256k", displayName: "Inkling 256K",
               capabilities: [.streaming, .toolCalling, .vision, .audio, .reasoning],
               contextWindow: 262_144,
               maxOutputTokens: 32_768,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .high),
               isFullySupported: true, isSeeded: false),
        // Workers AI first-party `@cf/` chat models on the AI Gateway catalog.
        Record(id: "@cf/zai-org/glm-5.3", displayName: "GLM-5.3 (Workers AI)",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 1_048_576,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .max),
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/zai-org/glm-5.3-flash", displayName: "GLM-5.3-Flash (Workers AI)",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning],
               contextWindow: 1_048_576,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .max),
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/zai-org/glm-5.2", displayName: "GLM-5.2 (Workers AI)",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 202_752,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .high),
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/zai-org/glm-4.7-flash", displayName: "GLM-4.7-Flash (Workers AI)",
               capabilities: [.streaming, .toolCalling],
               contextWindow: 202_752,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/deepseek-ai/deepseek-v4-pro-0813", displayName: "DeepSeek V4 Pro 0813 (Workers AI)",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 1_048_576,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .high),
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/deepseek-ai/deepseek-v4-flash-0731", displayName: "DeepSeek V4 Flash 0731 (Workers AI)",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 1_048_576,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .high),
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/moonshotai/kimi-k2.7-code", displayName: "Kimi K2.7 Code (Workers AI)",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning],
               contextWindow: 262_144,
               reasoningConfig: ModelReasoningConfig(type: .toggle),
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/nvidia/nemotron-3-120b-a12b", displayName: "Nemotron 3 120B (Workers AI)",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 262_144,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: ReasoningEffort.none),
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/qwen/qwen3.8-27b", displayName: "Qwen3.8 27B (Workers AI)",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning],
               contextWindow: 262_144,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .xhigh),
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/qwen/qwq-32b", displayName: "QwQ-32B (Workers AI)",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 131_072,
               reasoningConfig: ModelReasoningConfig(type: .toggle),
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/qwen/qwen3-30b-a3b-fp8", displayName: "Qwen3 30B A3B FP8 (Workers AI)",
               capabilities: [.streaming, .toolCalling],
               contextWindow: 131_072,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/qwen/qwen2.5-coder-32b-instruct", displayName: "Qwen2.5 Coder 32B (Workers AI)",
               capabilities: [.streaming, .toolCalling],
               contextWindow: 131_072,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/openai/gpt-oss-120b", displayName: "GPT-OSS 120B (Workers AI)",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 131_072,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .medium),
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/openai/gpt-oss-20b", displayName: "GPT-OSS 20B (Workers AI)",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 131_072,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .medium),
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/google/gemma-4-26b-a4b-it", displayName: "Gemma 4 26B A4B (Workers AI)",
               capabilities: [.streaming, .toolCalling, .vision],
               contextWindow: 262_144,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/meta/llama-3.3-70b-instruct-fp8-fast", displayName: "Llama 3.3 70B FP8 (Workers AI)",
               capabilities: [.streaming, .toolCalling],
               contextWindow: 131_072,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/meta/llama-4-scout-17b-16e-instruct", displayName: "Llama 4 Scout (Workers AI)",
               capabilities: [.streaming, .toolCalling, .vision],
               contextWindow: 131_072,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/meta/llama-3.2-11b-vision-instruct", displayName: "Llama 3.2 11B Vision (Workers AI)",
               capabilities: [.streaming, .vision],
               contextWindow: 131_072,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/mistralai/mistral-small-3.1-24b-instruct", displayName: "Mistral Small 3.1 24B (Workers AI)",
               capabilities: [.streaming, .toolCalling, .vision],
               contextWindow: 131_072,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/ibm-granite/granite-4.0-h-micro", displayName: "Granite 4.0 H Micro (Workers AI)",
               capabilities: [.streaming, .toolCalling],
               contextWindow: 128_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "@cf/aisingapore/gemma-sea-lion-v4-27b-it", displayName: "Gemma SEA-LION v4 27B (Workers AI)",
    ...
    static let vercelAIGatewayRecords: [Record] = [
        // OpenAI
        Record(id: "openai/gpt-6-astra", displayName: "GPT-6 Astra",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning, .promptCaching],
               contextWindow: 1_050_000,
               maxOutputTokens: 128_000,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .medium),
        ...
        Record(id: "zai/glm-5.3-flash", displayName: "GLM 5.3 Flash",
               ...
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .max),
               isFullySupported: true, isSeeded: false),
        // GLM-5.3-FlashX (Vercel model table, added 2026-09-18): chat type, `zai/`
        // prefix. Same band as GLM-5.3-Flash upstream (always-on low/high/max,
        // docs.z.ai/guides/vlm/glm-5.3-flash) via glm53LowHighMaxReasoningEffortModelIDs.
        Record(id: "zai/glm-5.3-flashx", displayName: "GLM 5.3 FlashX",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning],
               contextWindow: 1_048_576,
               maxOutputTokens: 131_072,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .max),
