...
struct GenerationControls: Codable {
    ...
    /// Context/prompt cache controls across providers.
...
struct Usage: Codable {
    ...
    let cachedTokens: Int? // Cache hit/read tokens
    let cacheCreationTokens: Int? // Cache write/create tokens
    let cacheWriteTokens: Int? // Alias for providers that report write tokens separately
