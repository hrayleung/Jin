...
extension ModelCatalog {
    ...
    private static let vercelAIGatewayRecords: [Record] = [
        ...
        // xAI
        Record(id: "xai/grok-4.1-fast-non-reasoning", displayName: "Grok 4.1 Fast (Non-Reasoning)",
               capabilities: [.streaming, .toolCalling, .promptCaching],
               contextWindow: 2_000_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "xai/grok-4.1-fast-reasoning", displayName: "Grok 4.1 Fast (Reasoning)",
        ...
        // ZAI / MiniMax / Moonshot
        Record(id: "zai/glm-5", displayName: "GLM-5",
               capabilities: [.streaming, .toolCalling, .reasoning, .promptCaching],
               contextWindow: 202_800,
               reasoningConfig: ModelReasoningConfig(type: .toggle),
               isFullySupported: true, isSeeded: false),
        Record(id: "zai/glm-4.7", displayName: "GLM-4.7",
               capabilities: [.streaming, .toolCalling, .reasoning, .promptCaching],
