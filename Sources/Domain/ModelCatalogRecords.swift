...
extension ModelCatalog {
    ...
    private static let xAIRecords: [Record] = [
        // Seeded
        Record(id: "grok-4.20-beta-0309-reasoning", displayName: "Grok 4.2 (Reasoning)",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning, .promptCaching, .nativePDF],
        ...
        Record(id: "grok-4-1", displayName: "Grok 4.1",
               ...
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: true),
        Record(id: "grok-code-fast-1", displayName: "Grok Code Fast 1",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 256_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: true),
        ...
        Record(id: "grok-imagine-video", displayName: "Grok Imagine Video",
               ...
               isFullySupported: true, isSeeded: true),
        // Catalog-only
        Record(id: "grok-4.20-beta-0309-non-reasoning", displayName: "Grok 4.2 (Non-Reasoning)",
               capabilities: [.streaming, .toolCalling, .vision, .promptCaching, .nativePDF],
               contextWindow: 2_000_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "grok-4.20-multi-agent-beta-0309", displayName: "Grok 4.2 Multi-Agent",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning, .promptCaching, .nativePDF],
               contextWindow: 2_000_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
    ...
    private static let openRouterRecords: [Record] = [
        ...
        Record(id: "google/gemini-3.1-pro-preview", displayName: "Gemini 3.1 Pro (Preview)",
               ...
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .high),
               isFullySupported: true, isSeeded: false),
        Record(id: "x-ai/grok-4.20-beta-0309-reasoning", displayName: "Grok 4.2 (Reasoning)",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning],
               contextWindow: 2_000_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "x-ai/grok-4.20-beta-0309-non-reasoning", displayName: "Grok 4.2 (Non-Reasoning)",
               capabilities: [.streaming, .toolCalling, .vision],
               contextWindow: 2_000_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "x-ai/grok-code-fast-1", displayName: "Grok Code Fast 1",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 256_000,
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
