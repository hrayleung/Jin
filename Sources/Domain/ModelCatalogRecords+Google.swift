...
extension ModelCatalog {
    ...
    static let geminiRecords: [Record] = [
        ...
        Record(id: "gemini-3-flash-preview", displayName: "Gemini 3 Flash (Preview)",
               ...
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .high),
               isFullySupported: true, isSeeded: true),
        // Gemini 3.8 Flash (2026-09). Thinking is LOW/MEDIUM/HIGH — MINIMAL is rejected by the API.
        Record(id: "gemini-3.8-flash", displayName: "Gemini 3.8 Flash",
               capabilities: [.streaming, .toolCalling, .vision, .videoInput, .audio, .reasoning, .promptCaching, .nativePDF, .codeExecution],
               contextWindow: 1_048_576,
               maxOutputTokens: 65_536,
    ...
    static let openRouterRecords: [Record] = [
        ...
        Record(id: "meta/muse-spark-1.1", displayName: "Meta: Muse Spark 1.1",
               ...
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .medium),
               isFullySupported: true, isSeeded: false),
        Record(id: "meta/muse-spark-1.2-contributor", displayName: "Meta: Muse Spark 1.2 Contributor",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning, .promptCaching],
               contextWindow: 1_048_576,
               maxOutputTokens: 131_072,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .medium),
        ...
        Record(id: "inclusionai/ling-2.6-flash", displayName: "inclusionAI: Ling-2.6-flash",
               ...
               reasoningConfig: nil,
               isFullySupported: true, isSeeded: false),
        Record(id: "inclusionai/ling-3.0-flash", displayName: "inclusionAI: Ling-3.0-Flash",
               capabilities: [.streaming, .toolCalling, .reasoning, .promptCaching],
               contextWindow: 262_144,
               maxOutputTokens: 32_768,
               reasoningConfig: ModelReasoningConfig(type: .toggle),
               isFullySupported: true, isSeeded: false),
        Record(id: "inclusionai/ling-3.0-flash-fin", displayName: "inclusionAI: Ling-3.0-Flash-Fin",
               capabilities: [.streaming, .toolCalling, .reasoning, .promptCaching],
               contextWindow: 262_144,
               maxOutputTokens: 32_768,
               reasoningConfig: ModelReasoningConfig(type: .toggle),
        ...
        Record(id: "anthropic/claude-opus-4.6-fast", displayName: "Anthropic: Claude Opus 4.6 (Fast)",
               ...
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .high),
               isFullySupported: true, isSeeded: false),
        Record(id: "z-ai/glm-5.3", displayName: "Z.ai: GLM 5.3",
               capabilities: [.streaming, .toolCalling, .reasoning, .promptCaching],
               contextWindow: 1048576,
               maxOutputTokens: 131072,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .max),
               isFullySupported: true, isSeeded: false),
        // GLM-5.3-Flash (OpenRouter live /models, 2026-08-26). Exact ID
        // `z-ai/glm-5.3-flash`. models.dev `openrouter` lists 1,310,720 / 131,072,
        // tools, cached-input, text+image+video. Video is NOT claimed — this is the
        // GA of stealth/ox-alpha, whose live video_url probe returned 400.
        // Always-on low/high/max (docs.z.ai/guides/vlm/glm-5.3-flash).
        Record(id: "z-ai/glm-5.3-flash", displayName: "Z.ai: GLM 5.3 Flash",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning, .promptCaching],
        ...
        Record(id: "openai/gpt-6-astra", displayName: "OpenAI: GPT-6 Astra",
               capabilities: [.streaming, .toolCalling, .vision, .reasoning, .promptCaching],
               contextWindow: 1050000,
               maxOutputTokens: 128000,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .medium),
        ...
        Record(id: "nex-agi/nex-n2.5-pro:free", displayName: "Nex AGI: Nex-N2.5 Pro (Free)",
               ...
               reasoningConfig: ModelReasoningConfig(type: .toggle),
               isFullySupported: true, isSeeded: false),
        Record(id: "nex-agi/nex-n2.5-mini:free", displayName: "Nex AGI: Nex-N2.5 Mini (Free)",
               capabilities: [.streaming, .toolCalling, .reasoning],
               contextWindow: 262144,
               maxOutputTokens: 65536,
               reasoningConfig: ModelReasoningConfig(type: .toggle),
        ...
        Record(id: "nex-agi/nex-n2-mini", displayName: "Nex AGI: Nex-N2-Mini",
               ...
               reasoningConfig: ModelReasoningConfig(type: .toggle),
               isFullySupported: true, isSeeded: false),
        Record(id: "inception/mercury-2", displayName: "Inception: Mercury 2",
               capabilities: [.streaming, .toolCalling, .reasoning, .promptCaching],
               contextWindow: 128_000,
               maxOutputTokens: 50_000,
               reasoningConfig: ModelReasoningConfig(type: .effort, defaultEffort: .high),
               isFullySupported: true, isSeeded: false),
        Record(id: "inception/mercury-2.5-preview", displayName: "Inception: Mercury 2.5 Preview",
               capabilities: [.streaming, .toolCalling, .reasoning, .promptCaching],
