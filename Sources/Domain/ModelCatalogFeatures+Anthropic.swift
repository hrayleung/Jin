...
extension ModelCatalog {
    ...
    static let anthropicDeclaredFeaturesByID: [String: ModelFeatures] = [
        "claude-3-5-haiku-latest": .init(webSearch: true, codeExecution: true),
        "claude-3-7-sonnet-20250219": .init(webSearch: true, codeExecution: true),
        "claude-fable-5": .init(
            webSearch: true,
            codeExecution: true,
        ...
        "claude-opus-4-20250514": .init(webSearch: true, codeExecution: true),
        ...
        "claude-sonnet-4-20250514": .init(webSearch: true, codeExecution: true),
