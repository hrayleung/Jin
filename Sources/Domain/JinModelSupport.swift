...
enum JinModelSupport {
    ...
    private static let fullySupportedModelsByProvider: [ProviderType: Set<String>] = [
        ...
        .cloudflareAIGateway: [
            // OpenAI-compatible endpoint uses `{provider}/{model}` IDs.
            "openai/gpt-5",
            "openai/gpt-5.2",
            ...
            "google-vertex-ai/google/gemini-3",
            "google-vertex-ai/google/gemini-3-pro-preview",
            "google-vertex-ai/google/gemini-3.1-pro-preview",
            "google-vertex-ai/google/gemini-3-flash-preview",
            "google-vertex-ai/google/gemini-2.5",
